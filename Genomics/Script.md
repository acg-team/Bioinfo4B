...
- The script will create html files for each reads file you have. Type the following to open the html files (this will list all the content in your working directory. So you may use it also to download any files from your folder):
```
